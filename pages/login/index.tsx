    ...
    if (email && password) {
      try {
        ...
        if (login) {
          ...
          setShowModal(true);
          addAccessToken(login.data.token);
          addUserNameToStorage(login.data.username);
          addUserId(login.data.userId);
        }
      } catch (error) {
      ...
      <div className="font-[sans-serif] text-[#333] bg-white">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 items-center lg:gap-8 gap-4 h-full">
          <div className="max-md:order-1 lg:col-span-2 md:h-screen w-full md:rounded-tr-xl md:rounded-br-xl lg:p-12 p-8">
            <img
              src="https://static.kfcvietnam.com.vn/images/web/signin/lg/signin.jpg?v=3oOMd3"
